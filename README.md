...
mkdir swan-provider
cd swan-provider
wget --no-check-certificate https://github.com/filswan/go-swan-provider/releases/download/v0.2.1-rc2/install.sh
chmod +x ./install.sh
./install.sh
```
...
```shell
./swan-provider-0.2.1-rc2-linux-amd64   #After installation from Option 1
...
- Such as:
```shell
nohup ./swan-provider-0.2.1-rc2-linux-amd64 >> swan-provider.log &   #After installation from Option 1
