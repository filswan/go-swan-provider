...
mkdir swan-provider
cd swan-provider
wget https://github.com/filswan/go-swan-provider/releases/download/v0.2.0-rc3/install.sh
chmod +x ./install.sh
./install.sh
```
...
```shell
./swan-provider-0.2.0-rc3-unix   #After installation from Option 1
...
- Such as:
```shell
nohup ./swan-provider-0.2.0-rc3-unix >> swan-provider.log &   #After installation from Option 1
