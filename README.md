...
####  Build Instructions
```shell
wget --no-check-certificate https://github.com/filswan/go-swan-provider/releases/download/v2.7.0/install.sh
chmod +x ./install.sh
./install.sh
```
#### Config and Run
...
ulimit -SHn 1048576
export SWAN_PATH="/data/.swan"
nohup swan-provider-2.7.0-linux-amd64 daemon >> swan-provider.log 2>&1 & 
```
